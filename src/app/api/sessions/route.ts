...
}).refine((d) => d.maxPlayers >= d.minPlayers, { message: "maxPlayers must be >= minPlayers", path: ["maxPlayers"] });
    ...
    const [sessions, total] = await Promise.all([
        db.gameSession.findMany({
            ...
            include: {
                ...
                reservation: { select: { id: true, startTime: true, endTime: true, table: { select: { id: true, name: true } } } },
