...
export default function GamesPage() {
    const games = [
        { name: "Dungeons & Dragons 5e", category: "RPG", players: "3-6", description: "Classic fantasy roleplaying" },
        { name: "Pathfinder 2e", category: "RPG", players: "3-6", description: "Tactical fantasy RPG" },
        { name: "Warhammer 40,000", category: "Wargame", players: "2", description: "Grimdark miniature battles" },
        { name: "Catan", category: "Board Game", players: "3-4", description: "Resource management classic" },
        { name: "Gloomhaven", category: "Board Game", players: "1-4", description: "Tactical dungeon crawler" },
    ];
