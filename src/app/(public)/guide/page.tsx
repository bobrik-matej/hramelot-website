                ...
                <CardContent className="pt-6">
                    <Accordion type="single" collapsible className="w-full">
                        ...
                        <AccordionItem value="item-3">
                            ...
                            <AccordionContent>
                                Bring your character sheet, dice (or use our digital tools), and enthusiasm! We provide
                                maps, miniatures, and reference materials. Snacks and drinks are allowed.
                            </AccordionContent>
                        </AccordionItem>
